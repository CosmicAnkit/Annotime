...
class TextEditor(QWidget):
    def __init__(self, media_player: vlc.MediaPlayer):
        ...
        self.increase_font_button.setIcon(QIcon("icons/zoom_in.png"))
        ...
        self.decrease_font_button.setIcon(QIcon("icons/zoom_out.png"))
    ...
    def save_transcript(self):
        """ Save the transcript to the current file path or prompt for a new one. """
        ...
        try:
            ...
            print(f"Transcript saved to: {self.current_file_path}")
