...
class VideoPlayer(QWidget):
    def __init__(self):
        ...
        load_icon = QIcon("icons/load.png") # Create QIcon object explicitly
        ...
        volume_down_icon = QIcon("icons/volume_down.png")
        ...
        volume_up_icon = QIcon("icons/volume_up.png")
        ...
        self.unmute_icon = QIcon("icons/unmute.png")
