...
from PyQt5.QtGui import QIcon, QPalette, QColor  # Import for styling main window
...
class MainWindow(QMainWindow):
    ...
    def setup_menu(self):
        ...
        load_video_action.setIcon(QIcon("icons/load_menu.png")) # Set icon for Load Video
        ...
        clear_text_action.setIcon(QIcon("icons/clear_menu.png")) # Set icon for Clear Text
        ...
        exit_action.setIcon(QIcon("icons/exit_menu.png")) # Set icon for Exit
